...
user= 'root'
pwd= 'Shiva@123'
file_Afdwe= "APAC-FolderDocument-Weekend-Job-Errors.txt"
...
file_Afdwd= "APAC-FolderDocument-Daily-Job-Errors.txt"
...
if read1 != "":
    ...
    print(read1)
    df1=pandas.read_table(file_Afdwe,sep="ERROR",header=None)
    #df1.to_excel("APAC.xlsx",sheet_name="FolderDoc_WeekEnd",index_label='Sr No.', merge_cells=False)
else:
